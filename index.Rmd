...
link-citations: yes
url: 'https\://book.easypeasymethod.org/'
...
- [english](index.html) // ([pdf](easypeasy.pdf)) - (original) by Hackauthor²
- [deutsch](de/index.html) // ([pdf](de/easypeasy.pdf)) - by Tim Budweg
- [italiano](it/index.html) // ([pdf](it/easypeasy.pdf)) - by DavF23
- [svenska](sv/index.html) // ([pdf](sv/easypeasy.pdf)) - by Norman
- [русский](ru/index.html) // ([pdf](ru/easypeasy.pdf)) - by johnhoth
- [soomaaliga](so/index.html) // ([pdf](so/easypeasy.pdf)) - by Mohamed Abdulakadir
- [español](https://easypeasyespanol.github.io/) // ([pdf](translations/easypeasy_es.pdf))
- [français](translations/easypeasy_fr.pdf) // ([pdf](translations/easypeasy_fr.pdf))
...
- [العربية](translations/easypeasy_ar.pdf) // ([pdf](translations/easypeasy_ar.pdf))
- [türkçe](https://neverfapturkiye.com/konu/pornoyu-birakmanin-kolay-yolu.1259/) // ([pdf](translations/easypeasy_tr.pdf))
- [فارسی](translations/easypeasy_fa.pdf) // ([pdf](translations/easypeasy_fa.pdf))
- [polski](translations/easypeasy_pl.pdf) // ([pdf](translations/easypeasy_pl.pdf))
