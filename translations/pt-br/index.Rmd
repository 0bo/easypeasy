---
title: "EasyPeasy"
author: "[English (original) by Hackauthor²](../index.html) <br/> Brazilian Portuguese translation by **HackAuthorBR**"
lang: pt
date: "`r Sys.Date()`"
  ...
  bookdown::gitbook:
    config:
      fontsettings:
        ...
        family: sans
        size: 2
      edit : "https://gitlab.com/snuggy/easypeasy/-/blob/master/translations/pt-br/%s"
    includes:
...
<img src="images/easypeasy.png" width="350" height="460" alt="Cover image" />
...
O vício não funciona diferente disso.

Pessoalmente, a [versão original no Google Sites](https://sites.google.com/site/hackbookeasypeasy) (que não foi escrita por mim) mudou minha vida. Se você é como a maioria das pessoas, acabou descobrindo a pornografia quando era bem jovem e passou a utilizá-la desde então. Até se deparar com as chocante – e ainda censuradas – pesquisas alertando sobre os riscos. Como eu, você teve sucesso em diversos períodos de abstinência de diversas durações, mas sempre teve recaídas por conta de desejos fortes e ilusórios. Sinto prazer em dizer que o método que exponho aqui funciona de forma totalmente diferente e tem sido o único método que tem funcionado.
