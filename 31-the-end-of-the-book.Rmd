...
It's August 2022 and the upcoming 'No Nut November' is our best shot at significantly changing the world, then continuing that push.

## How so? {-}

Before November 2022, you'll have:

	* A new easypeasy -- resembling a chat, not just a rewrite of a rewrite
	* A toolkit for sharing the message online and locally (posters, wacko schemes, etc)
	* Enough online and media attention for catapulting it globally.

All open source, with crowdsourced translations (semi-automatically too) and a joy to read.
...
**[Urbit](https://urbit.org/understanding-urbit) ~mogsub-possum/coomer** -- you can find guides on [joining the network] and [using it] here.

**[Matrix]** -- if you're having problems connecting to Urbit.
...
It's not ready yet because it all has to be perfectly structure, but you can join the various channels now and chat.

### What about you? {-}

Frankly speaking, I'm planning on appearing in online and traditional media during No Nut November.

I don't want to be an influencer or anything, but getting an audience is the best way of directing people into sustainability, community building and education projects. Also, I'm simply enjoying making calm videos.

I'd better introduce myself then.

My name's Fraser, and I'm a 23 year old psychology student from Australia, but right now -- August 2022 -- I'm living on an Alaskan farm.
...
So here's where I exist online.
...
**tok:** https://tiktok.com/@deletetoktokplease -- I don't post or use this.
...
To which I'll simply provide a quote.
...
--- Meta Nomad, [Exiting Modernity](https://www.meta-nomad.net/exiting-modernity/)
