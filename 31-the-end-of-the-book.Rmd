...
So, I thought creating a place to share useful wisdom nuggets would be cool, somewhere you can <https://learnstuff.today> in the easiest and most effective way.

Everything there is completely free and open source, so that people can improve it, and as knowledge should always be kept free, and we have guides for curing myopia (shortsightedness / "can't see long") if you weren't born with it (which is 95% of cases), type two diabetes, physical fitness, social skills and attraction, and many more.
...
If you're an edgelord, you should check out the <https://cooeer.org/ethos>, and to consider the world's complexity and the ego-escalation inheriant in screen addiction, otherwise you'll be unironically called cringe.

Anyway, it's also my favourite meme and I hope you'll love it too x

- **Creating conversations**

![local impact checklist](https://quiteasily.org/images/quiteasily_local-3-7-24-p-1080.png)
...
Could you please read [17776 -- An American Football Story by Jon Bois](https://sbnation.com/a/17776), and then, if you want write fanfiction about it. Post it somewhere, somewhere funny, and feel free to link me to it.

You can find me on

[deleteinstaplease](https://instagram.com/deleteinstaplease)

[deletexpls](https://x.com/deletexpls)

[deletetoktokpls](https://tiktok.com/@deletetoktokpls)

[Fraser Patterson](youtube.com/@fraserpattersonau) on deleteyoutubeplease


or as ~racnec-palren/peaceful on [urbit](https://whatsurbit.org)

I'll read every single one.


Until wherever we meet again,
