...
- [english](index.html) // ([pdf](easypeasy.pdf)) - by Hackauthor²
- [deutsch](de/index.html) // ([pdf](de/easypeasy.pdf)) - by Tim Budweg
- [español](https://easypeasyespanol.github.io/) // ([pdf](https://gitlab.com/snuggy/easypeasy/-/raw/master/translations/easypeasyespanol.pdf))
