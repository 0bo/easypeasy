...
- [español](https://easypeasyespanol.github.io/) // ([pdf](resources/easypeasy_es.pdf))
- [français](https://drive.google.com/file/d/1eCD_I5xpb8Nl3kMFIxVDNX8KI-WM5zPz/view) // ([pdf](resources/easypeasy_fr.pdf))
- [português](https://metodofacil.org/) // ([pdf](resources/easypeasy_pt.pdf))
- [magyar](https://sites.google.com/view/jarhatout) // ([pdf](resources/easypeasy_hu.pdf))
- [العربية](https://gitlab.com/snuggy/easypeasy/-/raw/master/translations/easypeasyar.pdf) // ([pdf](resources/easypeasy_ar.pdf))
- [türkçe](https://neverfapturkiye.com/konu/pornoyu-birakmanin-kolay-yolu.1259/) // ([pdf](resources/easypeasy_tr.pdf))
