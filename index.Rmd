...
- [italiano](it/index.html) / ([pdf](it/easypeasy.pdf))
- [magyar](https://sites.google.com/view/jarhatout) / ([pdf](translations/easypeasy_hu.pdf))
- [nederlands](nl/index.html) / ([pdf](nl/easypeasy.pdf))
- polski / ([pdf](translations/easypeasy_pl.pdf))
- [português-br](pt-br/index.html) / ([pdf](https://easypeas-traducao-portugues-jetro-costa-9d8ebb1e6fd21b45cfd6f1c.gitlab.io/pt-br/easypeasy.pdf)) / ([EPUB](https://easypeas-traducao-portugues-jetro-costa-9d8ebb1e6fd21b45cfd6f1c.gitlab.io/pt-br/easypeasy.epub))
- [română](ro/index.html) / ([pdf](ro/easypeasy.pdf))
- [shqip](sq/index.html) / ([pdf](sq/easypeasy.pdf))
- [soomaaliga](so/index.html) / ([pdf](so/easypeasy.pdf))
- [svenska](sv/index.html) / ([pdf](sv/easypeasy.pdf))
...
- [русский](ru/index.html) / ([pdf](ru/easypeasy.pdf))
- العربية / ([pdf](translations/easypeasy_ar.pdf))
- فارسی / ([pdf](translations/easypeasy_fa.pdf))

[Want to help translating?](translations/howtotranslate.pdf)
...
) of *Allen Carr's EasyWay to Quit Smoking* for pornography, it's free and open source and licensed under CC-BY-SA. Its success rests on the foundation that you:
